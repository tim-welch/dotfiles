...
[[ -f $SRC/freetype2/freetype-2.10.4.tar.xz ]] || { mkdir -p $SRC/freetype2 && curl -o $SRC/freetype2/freetype-2.10.4.tar.xz https://downloads.sourceforge.net/freetype/freetype-doc-2.10.4.tar.xz; } 
cd $SRC/freetype2
